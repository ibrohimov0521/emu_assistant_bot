...
EXTRA_NAMES: dict[str, tuple[str, ...]] = {
    ...
    "Narpay tumani": ("Oqtosh", "Oktosh", "Narpay"),
    "Oqdaryo tumani": ("Loyish", "Layish", "Oqdaryo"),
    "Pastdarg‘om tumani": ("Juma", "Jumabozor", "Pasdarg'on", "Pasdargon", "Pastdargon"),
    ...
    # Toshkent viloyati
    "O‘rtachirchiq tumani": ("Toʻytepa", "Toytepa", "Nurafshon shahri", "Ortachirchiq", "O'rta chirchiq", "Orta chirchiq", "O'rta chiqchiq", "Orta chiqchiq"),
    "Quyichirchiq tumani": ("Doʻstobod", "Dostobod", "Quyi Chirchiq", "Quyi chiqchiq", "Quyi chichiq"),
